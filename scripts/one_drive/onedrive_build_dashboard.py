...
def build_dashboard():
    ...
    html = [
        ...
        "const ONEDRIVE_ACCESS_TOKEN = '';",  # We'll handle this differently
        ...
        "    ",
        "    // Instead of trying to fetch, just show the URL and let user open it",
        "    alert('Decryption successful! URL: ' + decrypted + '\\n\\nYou can copy this URL and open it in a new tab.\\nNote: JavaScript may not execute when opened from OneDrive.');",
        "    ",
        "  } catch (e) {",
        ...
        "}",
        "",
        "// Open report with encrypted URL - simplified approach",
        ...
        "        ",
        "        // Open the sharing link directly in a new tab",
        "        // This will show the HTML file in OneDrive's viewer",
        "        // Note: JavaScript may not execute in OneDrive's viewer",
        "        window.open(decryptedUrl, '_blank');",
        "        ",
        "        // Alternative: Show URL for manual copy-paste",
        "        setTimeout(() => {",
        "          const shouldDownload = confirm('Report opened in OneDrive. JavaScript may not execute properly.\\n\\nWould you like to download the file and open it locally for full functionality?');",
        "          if (shouldDownload) {",
        "            // Create download link",
        "            const downloadLink = document.createElement('a');",
        "            downloadLink.href = decryptedUrl;",
        "            downloadLink.download = `report_${project}_${suite}_${date}.html`;",
        "            document.body.appendChild(downloadLink);",
        "            downloadLink.click();",
        "            document.body.removeChild(downloadLink);",
        "            alert('File downloaded. Please open the downloaded HTML file in your browser for full JavaScript functionality.');",
        "          }",
        "        }, 1000);",
        "        ",
        "      } catch (urlError) {",
        "        console.error('Invalid URL:', decryptedUrl);",
        "        alert('Decrypted URL is invalid: ' + decryptedUrl);",
        "      }",
        "      ",
        "    } catch (e) {",

...
def build_dashboard():
    ...
    html = [
        ...
        "th { background-color: #2b2b2b; font-weight: bold; position: sticky; top: 0; z-index: 2; box-shadow: 1px 0 0 0 #2b2b2b; }",
        "th:first-child { position: sticky; left: 0; z-index: 3; background-color: #2b2b2b; text-align: left; padding-left: 8px; border-right: 2px solid #444; box-shadow: 0 1px 0 0 #2b2b2b, 1px 0 0 0 #2b2b2b; }",
        ...
        f".suite-name {{ position: sticky; left: 0; background-color: #1e1e1e; width: {left_col_width}px; text-align: left; padding-left: 8px; font-weight: normal; z-index:1; border-right: 2px solid #444; box-shadow: 1px 0 0 0 #1e1e1e; }}",
        ".project-header { position: sticky; left: 0; display: table-cell; background-color: #1e1e1e; text-align: left; padding-left: 8px; font-weight: bold; z-index: 3; border-right: 2px solid #444; border-bottom: 2px solid #444; box-shadow: 1px 0 0 0 #1e1e1e; }",
